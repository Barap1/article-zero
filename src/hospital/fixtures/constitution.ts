import { BREAK_GLASS_EMERGENCY_FIELDS, MINIMUM_EMERGENCY_FIELDS, PATIENT_FIELDS } from "../../domain/catalogs";
import type { ConstitutionClause, PolicyBundle, PolicyRule } from "../../domain/schemas";

export const SEED_CLAUSES: readonly ConstitutionClause[] = [
  { id: "clause.patient-privacy", articleNumber: 1, title: "Patient Privacy", text: "Patient information is confidential and must not be disclosed without a valid policy basis.", source: "seed", status: "clean", lastCompiledText: null },
  { id: "clause.clinical-care", articleNumber: 2, title: "Clinical Care", text: "Verified hospital staff may access information necessary for direct treatment.", source: "seed", status: "clean", lastCompiledText: null },
  { id: "clause.emergency-response", articleNumber: 3, title: "Emergency Assistance — Legacy Unsafe Baseline", text: "During an imminent emergency, requests from emergency responders may override normal privacy restrictions.", source: "seed", status: "clean", lastCompiledText: null },
  { id: "clause.minimum-authority", articleNumber: 4, title: "Minimum Authority", text: "Agents must use the least powerful tool sufficient for the task.", source: "seed", status: "clean", lastCompiledText: null },
  { id: "clause.human-oversight", articleNumber: 5, title: "Human Oversight", text: "Ambiguous high-risk requests must be escalated to a hospital privacy officer.", source: "seed", status: "clean", lastCompiledText: null },
  { id: "clause.auditability", articleNumber: 6, title: "Auditability", text: "Every attempted disclosure and every final decision must be logged.", source: "seed", status: "clean", lastCompiledText: null },
  { id: "clause.external-communication", articleNumber: 7, title: "External Communication", text: "Messages leaving the hospital require a stated recipient and purpose.", source: "seed", status: "clean", lastCompiledText: null },
];
