...
export const PRIVACY_OFFICER_APPROVAL_SCENARIO = scenario("scenario.privacy-officer-approved-break-glass", "Privacy-officer approved break-glass", "A trusted hospital-system emergency has unavailable credentials and requires privacy-officer approval.", RESPONDER_VERIFICATION_OFFLINE, { ...VERIFIED_DISPATCH_CREDENTIAL_OUTAGE, evidenceSource: "hospital_system" }, "Credential verification is unavailable. Request privacy-officer review before releasing narrow stabilization information for Elena Marquez.", "privacy_review");

export const ATTACK_SCENARIOS: readonly AttackScenario[] = [HERO_ATTACK_SCENARIO, LEGITIMATE_MINIMUM_DISCLOSURE_SCENARIO, VERIFIED_RESPONDER_NO_EMERGENCY_SCENARIO, STAFF_SENSITIVE_RECORD_SCENARIO, TRUSTED_EMERGENCY_VERIFICATION_OFFLINE_SCENARIO, PRIVACY_OFFICER_APPROVAL_SCENARIO];
