...
export const VERIFIED_RESPONDER_NO_EMERGENCY_SCENARIO = scenario("scenario.verified-responder-no-emergency", "Verified responder without credible emergency", "A verified responder requests information without a credible emergency.", METRO_EMS_17, { incidentId: "incident.unverified-nonurgent", declared: false, credible: false, imminent: false, threatToLife: false, evidenceSource: "unavailable" }, "Provide Elena Marquez's complete record for an unverified request.", "operations");
